...
|---|---|---|
| 🏆 **Paris sportifs** | Application de prévision de paris sportifs | Java · Hibernate · MySQL · HTML/CSS · Git |
| 🚗 **Covoiturage** | Application mobile de covoiturage | Java · Android Studio · SQLite · XML |
| 🎮 **Jeu en ligne** | Application de jeu multijoueur en ligne | Java · MySQL · HTML/CSS · NetBeans |
...
![Top Langs](https://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=Maeckel&theme=tokyonight)
